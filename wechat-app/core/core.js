...
if (typeof wx !== "undefined") {
    ...
    wm.getSystemInfoSync = function () {
        var data = getSystemInfoSync();
        return data;
    };

    var setStorageSync = my.setStorageSync;
    wm.setStorageSync = function (key, value) {
    ...
    wm.getStorageSync = function (key) {
    ...
    wm.removeStorageSync = function (key) {
        removeStorageSync({
            key: key,
        });
    };

    wm.request = function (args) {
    ...
    wm.setNavigationBarColor = function (args) {
    ...
    wm.setNavigationBarTitle = function (args) {
        if (!args.title)
            return;
        my.setNavigationBar({
            title: args.title,
    ...
    wm.createAnimation = function (args) {
        return animation({
    ...
    wm.requestPayment = function (args) {
        my.tradePay({
    ...
    wm.setClipboardData = function (args) {
        args['text'] = args.data || '';
        my.setClipboard(args);
    };

    var makePhoneCall = my.makePhoneCall;
    wm.makePhoneCall = function (args) {
        args['number'] = args.phoneNumber || '';
        makePhoneCall(args);
    };

    wm.getSetting = function (args) {

    };

    var saveImage = my.saveImage;
    wm.saveImageToPhotosAlbum = function (args) {
        saveImage({
            url: args.filePath,
    ...
    wm.showActionSheet = function (args) {
        showActionSheet({
            items: args.itemList || [],
            success: function (res) {
                if (typeof args.success !== 'function')
